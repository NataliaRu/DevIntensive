...
public class PreferencesManager {
    ...
    public List<String> loadUserProfileData (){
        ...
        defaultUserData.add(DevIntensiveApplication.getContext().getResources().getString(R.string.profile_user_email));
        defaultUserData.add(DevIntensiveApplication.getContext().getResources().getString(R.string.profile_user_vk));
        defaultUserData.add(DevIntensiveApplication.getContext().getResources().getString(R.string.profile_user_gitHub));
        defaultUserData.add(DevIntensiveApplication.getContext().getResources().getString(R.string.profile_user_about));
        for (int i = 0; i < USER_FIELDS.length ; i++) {
